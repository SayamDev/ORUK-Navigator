...
const conceptPhrases: Record<string, string[]> = {
  ...
  "homelessness-risk": [
    "homeless", "evict", "kicked out", "kicking me out", "thrown out", "losing my home", "losing their home",
    "lose my home", "nowhere to live", "nowhere to stay", "sleeping rough", "sofa surf", "notice to leave",
    "section 21",
  ],
...
function explainMatch(concepts: string[], matchedField?: string): string {
  const conceptLabels: Record<string, string> = {
    ...
    "homelessness-risk": "help for people at risk of losing their home",
