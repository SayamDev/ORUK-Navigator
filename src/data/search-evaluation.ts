...
export const searchEvaluationCases: SearchEvaluationCase[] = [
  ...
  { id: "landlord-eviction", query: "My landlord is kicking me out and I can't pay rent", expectedSlugs: ["tameside-homelessness-service", "housing-payments"], note: "Everyday eviction wording must reach the homelessness service, alongside help with rent." },
  { id: "eviction-notice", query: "I've been given an eviction notice", expectedSlugs: ["tameside-homelessness-service"], note: "Eviction is a risk of homelessness covered by the reviewed homelessness source." },
  { id: "nowhere-to-live", query: "I have nowhere to live", expectedSlugs: ["tameside-homelessness-service"], note: "The reviewed source covers people who are homeless." },
