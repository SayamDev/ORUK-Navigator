  ...
  return (
    <>
      ...
      <main id="main-content" className="shell search-main">
        <form className="search-panel" method="post" onSubmit={submit} noValidate>
          ...
          <div className="field">
            ...
            <textarea id="need" name="need" rows={3} maxLength={240} autoComplete="off" aria-describedby="need-hint" value={need} onChange={(event) => setNeed(event.target.value)} />
          </div>
          <div className="field">
